...
3. Run a container from the image:
   ```bash
   podman run --detach debian13-itt:latest
   ```
...
[![REUSE status](https://api.reuse.software/badge/github.com/foundata/oci-debian13-itt)](https://api.reuse.software/info/github.com/foundata/oci-debian13-itt)
